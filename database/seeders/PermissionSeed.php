...
class PermissionSeed extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 36, 'title' => 'lease_access',],
            ['id' => 37, 'title' => 'lease_create',],
            ['id' => 38, 'title' => 'lease_edit',],
            ['id' => 39, 'title' => 'lease_view',],
            ['id' => 40, 'title' => 'lease_delete',],
            ['id' => 54, 'title' => 'lease_accept',],
            // ['id' => 41, 'title' => 'lease_renew',],
            ['id' => 42, 'title' => 'landlord_access',],
            ['id' => 43, 'title' => 'landlord_create',],
            ['id' => 44, 'title' => 'landlord_edit',],
            ['id' => 45, 'title' => 'landlord_view',],
            ['id' => 46, 'title' => 'landlord_delete',],
            ['id' => 52, 'title' => 'landlord_detach',],
            ['id' => 47, 'title' => 'tenant_access',],
            ['id' => 48, 'title' => 'tenant_create',],
            ['id' => 49, 'title' => 'tenant_edit',],
            ['id' => 50, 'title' => 'tenant_view',],
            ['id' => 51, 'title' => 'tenant_delete',],
            ['id' => 53, 'title' => 'tenant_detach',],
            ['id' => 55, 'title' => 'messenger_access',],
        ];

        foreach ($items as $item) {
            \App\Models\Permission::firstOrCreate($item);
        }
    }
}
