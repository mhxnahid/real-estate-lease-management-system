...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            {{-- <li class="user-profile">
                <a href="#">
                    ...
                    <span class="title">
                        ...
                        <span class="role">{{ Auth::user()->role()->pluck('title')->implode(' ') }}</span>
                    </span>
                </a>
            </li> --}}
            ...
            @can('landlord_access')
                <li class="{{ $request->segment(2) == 'landlords' ? 'active' : '' }}">
                    <a href="{{ route('admin.landlords.index') }}">
                        ...
                        <span class="title">@lang('global.landlords.title')</span>
                    </a>
                </li>
            @endcan
            @can('property_access')
            ...
            @endcan
            @can('lease_access')
                <li class="{{ $request->segment(2) == 'leases' ? 'active' : '' }}">
                    <a href="{{ route('admin.leases.index') }}">
                        <i class="fa fa-file-text"></i>
                        <span class="title">@lang('global.leases.title')</span>
                    </a>
                </li>
            @endcan
